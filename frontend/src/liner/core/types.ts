...
export type LinerDiagnosticCode =
  ...
  | "LINER_PROFILE_OVERLAP"
  | "LINER_PROFILE_GRADE_EXCEEDS_LIMIT"
  | "LINER_SPAN_END_EXCEEDS_ALIGNMENT"
  | "LINER_SPAN_START_NEGATIVE"
  | "LINER_SPAN_REVERSED"
  | "LINER_SPAN_DUPLICATE_ID"
  | "LINER_SPAN_PIER_REFERENCE_MISSING"
  | "LINER_PIER_DUPLICATE_ID"
  | "LINER_PIER_BEARING_OFFSET_INVALID"
  | "LINER_PIER_BEARING_OFFSET_DUPLICATE_INDEX"
  ...
  | "LINER_CROSS_SECTION_TEMPLATE_DUPLICATE_ID"
  | "LINER_CROSS_SECTION_TEMPLATE_MISSING_ID"
  | "LINER_CROSS_SECTION_OFFSET_LINE_DUPLICATE_ID"
  | "LINER_CROSS_SECTION_OFFSET_LINE_MISSING_ID"
  | "LINER_CROSS_SECTION_OFFSET_LINE_MISSING"
  | "LINER_CROSS_SECTION_GRID_DEFINITION_DUPLICATE_ID"
  | "LINER_CROSS_SECTION_GRID_DEFINITION_MISSING_ID"
  | "LINER_CROSS_SECTION_TEMPLATE_REFERENCE_MISSING"
  | "LINER_CROSS_SECTION_OFFSET_LINE_REFERENCE_MISSING"
  | "LINER_CROSS_SECTION_GRID_DEFINITION_INVALID_RANGE"
  | "LINER_CROSS_SECTION_GRID_DEFINITION_OVERLAP"
  | "LINER_ACTIVE_ALIGNMENT_REQUIRED"
  | "LINER_ACTIVE_LINE_REQUIRED"
  | "LINER_ALIGNMENT_DUPLICATE_ID"
  | "LINER_ALIGNMENT_EMPTY_NAME"
  | "LINER_ALIGNMENT_LAST_DELETE_FORBIDDEN"
  | "LINER_ALIGNMENT_REFERENCE_MISSING"
  | "LINER_LINE_BASELINE_CYCLE"
  | "LINER_LINE_BASELINE_SELF_REFERENCE"
  | "LINER_LINE_REFERENCE_MISSING"
  | "LINER_CROSS_ALIGNMENT_ID_COLLISION";
