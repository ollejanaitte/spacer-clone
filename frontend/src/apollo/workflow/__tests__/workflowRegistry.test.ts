...
describe("workflow registry", () => {
  ...
  it("keeps WF-06 as a future (non-gating) capability; WF-01 binding is now IMPLEMENTED", () => {
    expect(getWorkflowCapability("WF-01").status).toBe("IMPLEMENTED");
    ...
    expect(isFutureCapability("WF-01")).toBe(false);
