...
export const WORKFLOW_STEP_DEFINITIONS: readonly WorkflowStepDefinition[] = [
  ...
  },
  {
    ...
    supportedScope: "Step 4-B 実装後に評価",
    navigationTarget: PANEL("wf-panel-bridge-structure", "橋梁基本条件入力（付属物は未実装）"),
    primaryActionId: "none",
    completionCriterion: "付属物 canonical input (Step 4-B)",
  },
  {
  ...
  },
  {
    ...
    supportedScope: "Step 4-B 実装後に評価",
    navigationTarget: PANEL("wf-panel-bridge-structure", "ハンチ入力（未実装）"),
    primaryActionId: "none",
    completionCriterion: "ハンチ canonical input (Step 4-B)",
  },
  {
