...
export type GuardDialogPortalProps = {
...
export function GuardDialogPortal({
  open,
  children,
  onBackdropMouseDown,
  testId,
}: GuardDialogPortalProps) {
  ...
  useEffect(() => {
    ...
    el.setAttribute("data-guard-portal", "");
    el.className = "apollo-guard-backdrop";
