...
export function createApollo200mContinuousBridgeSample(): ProjectModel {
  ...
  const project: ProjectModel = {
    ...
    supports: [
      { nodeId: "N-A1", ux: true, uy: true, uz: true, rx: true, ry: true, rz: true },
      { nodeId: "N-P1", ux: true, uy: true, uz: true, rx: false, ry: false, rz: false },
      { nodeId: "N-P2", ux: true, uy: true, uz: true, rx: false, ry: false, rz: false },
      { nodeId: "N-P3", ux: true, uy: true, uz: true, rx: false, ry: false, rz: false },
      { nodeId: "N-P4", ux: true, uy: true, uz: true, rx: false, ry: false, rz: false },
      { nodeId: "N-A2", ux: true, uy: true, uz: true, rx: true, ry: true, rz: true },
    ],
