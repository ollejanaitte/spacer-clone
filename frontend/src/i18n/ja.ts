...
export const ja = {
  ...
  liner: {
    ...
    alignmentManager: {
      title: "線形一覧",
      lead: "複数の独立線形を管理します。現在選択中の線形が下の編集対象になります。",
      tableCaption: "線形一覧",
      name: "名称",
      id: "ID",
      enabled: "有効",
      ...
      select: "選択",
      current: "選択中",
      activeIndicator: (alignmentId: string) => `現在の線形: ${alignmentId}`,
    },
    lineManager: {
      title: "ライン一覧",
      lead: "基準線（中心線）とオフセット線を管理します。",
      tableCaption: "ライン一覧",
      label: "名称/記号",
      id: "ID",
      base: "基準線",
      ...
      select: "選択",
      current: "選択中",
      centerlineLabel: "基準（中心線）",
      baseSelf: "—",
      centerlineProtected: "削除不可",
    },
    setupTabs: {
      tablistLabel: "線形入力タブ",
      line: "ライン",
    ...
    setupTabPlaceholder: {
      ...
      review: {
        title: "確認図は正式図面ワークスペースで表示します",
        description:
          "このタブは橋梁配置（スパン・支承）専用です。平面・縦断・横断の確認図は「正式図面を開く」からご利用ください。",
        bullets: [
          "平面図（線形・IP・BC/EC・寸法・座標表）は正式図面の平面タブで表示します。",
          "縦断図（勾配・VCL・縦断曲線）は正式図面の縦断タブで表示します。地盤データは未設定のまま明示します。",
          "帯シート（横断勾配など）は縦断図に付属します。拡幅は別スライスまで利用不可（—）です。",
        ],
      },
    },
    ldist: {
      title: "LDIST（格点間距離・張り出し長）",
      addJob: "ジョブを追加",
      removeJob: "ジョブを削除",
      emptyJobs: "LDIST ジョブがありません。",
      jobLabel: "ラベル",
      jobKind: "種別",
      kindGridDistance: "格点間距離",
      kindOverhang: "張り出し長",
      distanceMode: "距離モード",
      modeA: "モード A（そのまま）",
      modeB: "モード B（× sin θ）",
      ...
      results: "計算結果",
      noResults: "結果がありません。",
      diagnosticsTitle: "LDIST 診断",
      columnJob: "ジョブ",
      columnStation: "測点",
      columnFrom: "From",
      columnTo: "To",
      columnDistance: "距離 (m)",
      columnOverhang: "張り出し (m)",
      columnSide: "側",
      diagnostics: {
        alignmentReferenceMissing: "指定された alignment が見つかりません。",
        lineReferenceMissing: "指定されたラインが見つかりません。",
        referenceLineRequired: "モード B では基準ラインが必須です。",
        stationOutOfRange: "測点が線形範囲外です。",
        degenerateGeometry: "幾何が退化しているため計算できません。",
        pierReferenceInvalid: "指定されたピアが無効です。",
        pierIdRequired: "同一測点に複数ピアがあるため pierId が必須です。",
        jobSchemaInvalid: "ジョブ定義が不正です。",
        pairsEmpty: "格点間距離ジョブにはペアが必要です。",
      },
    },
    haunch: {
      title: "HAUNCH（ハンチ計算）",
      addDefinition: "定義を追加",
      removeDefinition: "定義を削除",
      emptyDefinitions: "HAUNCH 定義がありません。",
      definitionLabel: "ラベル",
      family: "ファミリ",
      variant: "バリアント",
      familyTwoPoint: "2点",
      ...
      familyPlane: "平面",
      familyRange: "範囲",
      variantTwoSupportPoints: "2支点直線",
      variantOnePointGradient: "1点+縦勾配",
      variantAffinePlane: "3点平面",
      variantParabola: "3点放物線",
      variantPlaneGradients: "1点+縦横勾配",
      variantRangeModifier: "セクション範囲修飾",
      anchors: "アンカー",
      anchor: "アンカー",
      anchorStation: "測点 (m)",
      anchorMode: "入力モード",
      ...
      modeHaunch: "ハンチ量",
      selectLine: "選択してください",
      stationFrom: "測点 From (m)",
      stationTo: "測点 To (m)",
      longitudinalGradient: "縦勾配",
      transverseGradient: "横勾配",
      girderLine: "主桁ライン",
      rangeHelp: "範囲修飾は後続定義のスコープを制限します（数値行は出力しません）。",
      results: "計算結果",
      noResults: "結果がありません。",
      diagnosticsTitle: "HAUNCH 診断",
      columnDefinition: "定義",
      columnType: "タイプ",
      columnStation: "測点",
      columnTopElevation: "天端高 (m)",
      columnThickness: "ハンチ量 (m)",
      columnSide: "側",
      columnLine: "ライン",
      diagnostics: {
        unsupportedType: "サポートされていない HAUNCH タイプです。",
        invalidReference: "参照先が無効です。",
        profileUnavailable: "縦断プロファイルが利用できません。",
        stationOutOfRange: "測点が範囲外です。",
        rangeInvalid: "範囲指定が無効です。",
        overlappingRange: "範囲修飾が重複しています。",
        degenerateGeometry: "幾何が退化しているため計算できません。",
        negativeThickness: "負のハンチ量は許可されていません。",
        referenceGirderRequired: "基準桁の先行計算が必要です。",
        linerHeightRequired: "LINER 線形計算（W/WG）が必要です。",
        collinearAnchors: "アンカーが共線上にあります。",
        definitionSchemaInvalid: "定義スキーマが不正です。",
      },
    },
    hoso: {
      title: "HOSO（舗装厚計算）",
      addDefinition: "定義を追加",
      removeDefinition: "定義を削除",
      emptyDefinitions: "HOSO 定義がありません。",
      definitionLabel: "ラベル",
      family: "ファミリ",
      variant: "バリアント",
      familyAuto: "自動決定",
      familyLongitudinal: "縦断",
      familyTransverse: "横断",
      familyTwoPoint: "2点",
      familyThreePoint: "3点",
      variantAutoPipeline: "パイプライン自動",
      variantLongitudinalOnly: "縦断のみ",
      variantBothGradients: "縦断・横断勾配",
      variantTransverseOnly: "横断のみ",
      variantTwoPointGirderEnd: "桁端2点",
      variantThreePointPlane: "3点平面",
      anchorStation: "測点 (m)",
      anchorThickness: "舗装厚 (m)",
      stationFrom: "測点 From (m)",
      stationTo: "測点 To (m)",
      longitudinalGradient: "縦勾配",
      transverseGradient: "横勾配",
      results: "計算結果",
      noResults: "結果がありません。",
      diagnosticsTitle: "HOSO 診断",
      columnDefinition: "定義",
      columnType: "タイプ",
      columnStation: "測点",
      columnOffset: "オフセット (m)",
      columnThickness: "舗装厚 (m)",
      columnElevation: "舗装標高 (m)",
      columnLine: "ライン",
      diagnostics: {
        unsupportedType: "サポートされていない HOSO タイプです。",
        invalidReference: "参照先が無効です。",
        profileUnavailable: "縦断プロファイルが利用できません。",
        crossfallUnavailable: "横断勾配が利用できません。",
        stationOutOfRange: "測点が範囲外です。",
        offsetOutOfRange: "オフセットが範囲外です。",
        lineOutOfRange: "ラインが舗装範囲外です。",
        intersectingLines: "ライン交差により計算できません。",
        degenerateGeometry: "幾何が退化しているため計算できません。",
        collinearAnchors: "アンカーが共線上にあります。",
        negativeThickness: "負の舗装厚は許可されていません。",
        minThickness: "最小舗装厚を下回っています。",
        autoNotConverged: "自動決定の収束に失敗しました。",
        overlappingBand: "オフセット帯が重複しています。",
        definitionSchemaInvalid: "定義スキーマが不正です。",
        extractionRequired: "抽出記録の承認が必要です。",
      },
    },
    fields: {
      alignmentId: "線形ID",
    ...
    preview: {
      ...
      formalDrawingNotice:
        "JIP-LINER 互換の確認図（平面・縦断・横断・帯）は正式図面ワークスペースが一次入口です。このプレビューは格子概要の二次表示です。",
      openFormalDrawing: "正式図面ワークスペースを開く",
    ...
    errors: {
      ...
      active_alignment_required: "有効な線形が選択されていません。",
      active_line_required: "有効なラインが選択されていません。",
      alignment_duplicate_id: "線形IDが重複しています。",
      alignment_empty_name: "線形名称が未設定です。",
      alignment_last_delete_forbidden: "最後の線形は削除できません。",
      alignment_reference_missing: "選択中の線形が見つかりません。",
      line_baseline_cycle: "基準線参照が循環しています。",
      line_baseline_self_reference: "ラインが自身を基準線に参照しています。",
      line_reference_missing: "参照先ラインが見つかりません。",
      cross_alignment_id_collision: "線形間でIDが衝突しています。",
    ...
    formalDrawing: {
      ...
      scalePlan: (scale: string) => `S ${scale}`,
      scaleCrossSection: (scale: string) => `S ${scale}`,
      pageNavigationLabel: "図面ページ",
      pageIndicator: (pageNumber: number, pageCount: number) => `ページ ${pageNumber}/${pageCount}`,
      pageNames: {
        plan: "平面図",
        profile: "縦断図",
        crossSection: "横断図",
  ...
  substructure: {
    ...
    planning: {
      pageTitle: "下部工計画",
      noSelection: "未選択",
      selectSupportHint: "左のツリーまたはビューポートで支点を選択してください",
      mode2d: "2D",
      mode3d: "3D",
      panelTree: "ツリー",
      panelProperty: "プロパティ",
      ...
      treeTitle: "部材",
      emptyTree: "支点がありません",
      emptyViewport: "表示する部材がありません",
      placement: "配置",
      station: "測点",
      offset: "オフセット",
      structureType: "構造形式",
      formType: "形式",
      formSlotNotice: "入力フォームは M2-03 で実装予定",
      colSupport: "支点",
      colType: "種別",
      colStation: "測点",
      statusSelection: "選択",
      ...
      footingDims: "フーチング寸法",
      footingLengthLabel: "橋軸方向長 (m)",
      footingWidthLabel: "橋軸直角幅 (m)",
      footingThicknessLabel: "厚 (m)",
      pileDims: "杭",
      pileDiameterLabel: "杭径 (m)",
      pileLengthLabel: "杭長 (m)",
      layoutDims: "配置",
      rowsLabel: "X方向本数",
      colsLabel: "Y方向本数",
      spacingXLabel: "X間隔 (m)",
      spacingYLabel: "Y間隔 (m)",
      edgeXLabel: "X縁端 (m, 空=自動)",
      edgeYLabel: "Y縁端 (m, 空=自動)",
      autoArrange: "自動配置",
      planPreview: "平面プレビュー",
      invalidLayout: "配置を修正してください",
      coordinateTableTitle: "杭座標表",
      pileNo: "No",
      pileId: "杭ID",
      noPiles: "杭がありません",
  ...
  designPlatform: {
    ...
    businessList: {
      ...
      projectName: "業務名",
      designStage: "設計段階",
      columnProjectNumber: "業務件番",
      columnProjectName: "業務名",
      columnDesignStage: "設計段階",
      ...
      cancel: "キャンセル",
      back: "戻る",
      createPanelAria: "新規業務作成フォーム",
      projectNumberAndNameRequired: "業務件番と業務名は必須です。",
      stageLabels: {
        road_design: "道路設計",
        superstructure: "上部工",
        substructure: "下部工",
    ...
    workspace: {
      ...
      sectionNotices: {
        overview: "業務の概要・メタデータ・進捗を表示します。",
        road: "道路線形（LINER）への接続先です。",
        superstructure: "上部工（Apollo）への接続先です。",
        substructure: "下部工（Substructure）への接続先です。",
        analysis: "解析（FEM/Analysis）への接続先です。",
        main3d: "統合3D（Main3D）への接続先です。",
        deliverables: "成果物（帳票・図面・STL等）の一覧を表示します。",
        data: "業務のデータ管理（保存・読み込み）を提供します。",
      },
      stageLabels: {
        road_design: "道路設計",
        superstructure: "上部工",
  ...
  workflow: {
    stepLabels: {
      project: "新規Project / Project選択",
      siteContext: "現況・地理情報",
      road: "道路線形 / 道路設計",
      bridgePlacement: "橋梁配置 / 支間割",
      superstructure: "上部工設計",
      substructure: "下部工設計",
      analysis: "構造解析",
      main3d: "統合3D / CIM",
      deliverables: "成果物 / Export",
      saveClose: "保存 / Close / Reopen",
    },
    stepDescriptions: {
      project: "新規業務を作成するか、既存 Project を開きます。",
      siteContext: "対象地の座標系・地形・取得範囲など現況・地理情報を設定します。",
      road: "平面線形・縦断・横断を入力し道路線形を確定します (LINER)。",
      bridgePlacement: "道路線形上に橋梁位置・支間割を配置します (BridgeWizard)。",
      superstructure: "上部工 (主桁・床版) を設計します (Apollo)。",
      substructure: "下部工 (橋脚・橋台・基礎) を計画します (Substructure)。",
      analysis: "FEM / 構造解析を実行し結果を確認します。",
      main3d: "線形・上部工・下部工・地形を統合した 3D で確認します。",
      deliverables: "図面・帳票・3D 出力を生成します。",
      saveClose: "Project を保存・再読込します (project.json)。",
    },
    connectionStatus: {
      connected: "接続済み",
      partial: "一部接続",
    ...
    nav: {
      ...
      backToApp: "メイン画面へ戻る",
      ownerLane: "担当",
      handover: "Projectへの引継ぎ",
    },
    siteContext: {
      title: "現況・地理情報 (Site Context)",
      lead: "対象地の現況・地理情報を設定します。ここで設定した座標系・地形は、以降の道路・橋梁・解析・3D の基盤として同じ Project に引き継がれます。",
      projectLabel: "現在のProject",
      emptyProjectTitle: "Project が選択されていません",
      emptyProjectLead: "先に Project を作成または開いてください。",
      openProject: "メイン画面で Project を開く",
      sourceGridLabel: "現況の取得元",
      sourceMapName: "地図から取得",
      sourceMapDescription: "国土地理院の DEM 等を地図上で取得します (次Waveで実装)",
      sourceCad2dName: "2D図面から",
      sourceCad2dDescription: "DXF 等の 2D 図面から読み込みます (次期対応)",
      sourceCad3dName: "3Dデータから",
      sourceCad3dDescription: "3D CAD・点群データから読み込みます (次期対応)",
      sourceSurveyName: "測量データから",
      sourceSurveyDescription: "測量・XYZ/CSV データから読み込みます (次期対応)",
      later: "後で設定する",
      startWorkflow: "現況設定を開始する (インポート / DEM・地形)",
    },
    siteContextPage: {
      title: "現況・地理情報 (Site Context)",
      lead: "対象地の現況・地理情報を、.sitecontext パッケージのインポートと DEM/Terrain 取得で設定します。設定内容は同じ Project に引き継がれます。",
      projectLabel: "現在のProject",
      importSectionTitle: ".sitecontext パッケージ インポート",
      importSectionLead: "既存の site-context パッケージを検査・インポートします (現状は合成サンプルパッケージを使用)。",
      inspectButton: "パッケージを検査",
      importButton: "インポート確定",
      cancelButton: "キャンセル",
      retryButton: "再実行",
      closeResultButton: "結果を閉じる",
      inspecting: "パッケージを検査中…",
      importing: "インポート実行中…",
      cancelled: "インポートをキャンセルしました。",
      importOk: "インポートが完了しました。",
      importErrorTitle: "インポートに失敗しました (fail-closed)",
      errorCode: "エラーコード",
      errorMessage: "詳細",
      projectNameLabel: "Project名",
      projectIdLabel: "Project ID",
      warningsLabel: "警告",
      warningsEmpty: "警告なし",
      unsupportedLabel: "非対応フィールド",
      unsupportedEmpty: "非対応フィールドなし",
      diagnosticsLabel: "診断情報",
      migratedV1ToV2: "V1→V2 移行",
      selectionAreaMigrated: "選択範囲移行",
      sourceSchemaVersion: "ソーススキーマ",
      targetSchemaVersion: "ターゲットスキーマ",
      terrainCount: "Terrain数",
      crsEpsg: "CRS (EPSG)",
      crsSupported: "対応CRS",
      noPackageHint: "合成サンプルパッケージ (郡上八幡) を使用します。",
      demSectionTitle: "DEM / Terrain 取得",
      demSectionLead: "国土地理院の標高タイルを取得するか、郡上八幡のサンプル地形を読み込みます。",
      demPresetLabel: "DEM",
      demPreset5a: "DEM5A（航空レーザ 5m）",
      demPreset5b: "DEM5B（写真測量 5m）",
      demPreset10b: "DEM10B（等高線 10m）",
      demFetchButton: "DEM取得",
      demFetching: "DEM取得中… {loaded}/{total} タイル",
      demCancelButton: "取得キャンセル",
      demErrorAborted: "取得をキャンセルしました。",
      demErrorGeneric: "DEM取得に失敗しました: {message}",
      gujoSampleButton: "郡上サンプル地形を読み込む",
      gujoSampleLoading: "サンプル地形を読み込み中…",
      gujoSampleDone: "郡上サンプル地形を Project に設定しました。",
      previewTitle: "Terrain プレビュー",
      previewEmpty: "地形がまだ読み込まれていません。",
      previewGrid: "グリッド",
      previewCellSize: "解像度",
      previewElevationMin: "標高 min",
      previewElevationMax: "標高 max",
    ...
    roadWorkflow: {
      title: "道路線形 (Road Workflow)",
      lead: "道路線形を同じ Project に配置します。参照サンプル: 郡上市八幡 山岳道路 (RB001-ROAD-1)。",
      sourceLabel: "参照サンプル",
      roadId: "道路 ID",
      roadName: "道路名",
      alignmentId: "線形 ID",
      ...
      elementId: "ID",
      elementLength: "長さ",
      bridgeCandidateTitle: "橋梁候補区間",
      startStation: "開始測点",
      endStation: "終了測点",
      nominalSpan: "標準支間",
      note: "備考",
      placeRoadButton: "道路を Project に配置",
      placed: "道路を Project に配置しました。",
      alreadyPlaced: "この道路は Project に配置済みです。",
      placedAt: "配置日時",
      nextBridge: "次: 橋梁配置へ進む",
      prevSiteContext: "前: 現況・地理情報へ戻る",
      backToApp: "メイン画面へ戻る",
    },
    bridgeWorkflow: {
      title: "橋梁配置 / 支間割 (Bridge Workflow)",
      lead: "道路線形上の橋梁候補区間に、橋梁配置と支間割を設定します。",
      roadLabel: "道路",
      bridgeIdLabel: "橋梁 ID",
      rangeTitle: "橋梁区間",
      bridgeLength: "橋長",
      ...
      spanFromTo: "A1→P1",
      spanLength: "支間長",
      totalSpanLength: "支間合計",
      pierTitle: "橋脚配置",
      pierId: "橋脚",
      pierStation: "測点",
      autoPierButton: "等間隔で橋脚を配置",
      pierCountLabel: "橋脚数",
      placeBridgeButton: "橋梁配置を Project に確定",
      placed: "橋梁配置を Project に確定しました。",
      alreadyPlaced: "橋梁配置は設定済みです。",
      placedAt: "確定日時",
      noRoadHint: "先に「道路線形 (Road Workflow)」で道路を配置してください。",
      prevRoad: "前: 道路線形へ戻る",
      nextAnalysis: "次: 解析へ進む",
      backToApp: "メイン画面へ戻る",
    },
    toolbar: {
      openSiteContext: "現況・地理情報",
      openSiteContextTitle: "Canonical Workflow の「現況・地理情報 (Site Context)」を開きます。",
    },
  },
};
