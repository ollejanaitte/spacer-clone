...
export const ja = {
  ...
  level0: {
    ...
    bridgeLength: (value: string) => 橋長:  m,
    pierHeight: (value: string) => 橋脚高さ:  m,
    pierCount: (count: number) => 橋脚本数:  本,
    loadMultiplier: (value: string) => 荷重倍率:  倍,
