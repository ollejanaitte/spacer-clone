...
The response follows `docs/06_result_schema.md` and `schemas/result.schema.json`. Eigenvalue-specific data is stored under `eigenResult`.
...
For the detailed type definition, see [result-schema.md](result-schema.md).
