...
| 4 | **回転DOF（RX/RY/RZ）の3D可視化設計** | `docs/history/frame/handover/2026-06-next-tasks.md` §「回転自由度を可視化する場合は…表示仕様設計が必要」 | 解析結果の完全性 |

### リスク中低・効果中

| # | 改善内容 | 根拠ファイル | 効果 |
|---|----------|-------------|------|
| 5 | **固有値モード変位表示不具合の修正** | `docs/history/frame/handover/2026-06-next-tasks.md` 最優先 | ユーザー報告バグ修正 |
| 6 | **変位表示総点検**（静的/固有値/応答スペクトル/時刻歴 × 6自由度） | `docs/history/frame/handover/2026-06-next-tasks.md` | 表示整合性の保証 |
...
| 10 | **時刻歴結果表の改善** | `docs/history/frame/handover/2026-06-next-tasks.md` 未実装リスト | 結果確認の利便性 |
| 11 | **断面力分布図・カラーマップ・モーメント円弧矢印** | `docs/history/frame/handover/2026-06-next-tasks.md` 残課題 | 構造設計者の必須表示 |
...
| 13 | **SPACER比較モデル整備** | `docs/history/frame/handover/2026-06-next-tasks.md` 検証 | 信頼性向上 |
...
| 15 | **PDF帳票の動的解析結果出力強化** | `docs/history/frame/handover/2026-06-next-tasks.md` | 帳票の完全性 |
