...
> Step3: [step3_complete_dxf_implementation.md](step3_complete_dxf_implementation.md)
> Phase: Phase 5
> Ownership: confirmed facts / proposals / Open Decisions are separated
> PHASE5_FINAL_SCOPE_VERDICT: `READY_WITH_OPEN_DECISIONS`
> PHASE5_STEP2_READINESS: `COMPLETE`
> PHASE5_STEP3_READINESS: `COMPLETE`
...
phase5 配下の文書は次の 10 件を正とする。

1. [README.md](README.md)
2. [phase5_liner_formal_drawing_design.md](../../../road/output/phase5_liner_formal_drawing_design.md)
3. [drawing_model_design.md](../../../road/output/drawing_model_design.md)
4. [crossfall_transition_design.md](../../../road/design/crossfall_transition_design.md)
5. [implementation_plan.md](implementation_plan.md)
6. [formal_drawing_ui_design.md](../../../road/output/formal_drawing_ui_design.md)
7. [drawing_standard_preset_design.md](../../../road/output/drawing_standard_preset_design.md)
8. [dxf_export_design.md](../../../road/output/dxf_export_design.md)
9. [redline_ui_and_drawing_remediation_design.md](../../../road/output/redline_ui_and_drawing_remediation_design.md)
10. [step3_complete_dxf_implementation.md](step3_complete_dxf_implementation.md)
...
- DXF core（`DrawingDocument -> DxfDocument -> serializer`）は main にマージ済み。根拠: `frontend/src/liner/dxf/`.
- Step 3 完成実装方針は [step3_complete_dxf_implementation.md](step3_complete_dxf_implementation.md) を正とする（Plan / Profile+Band / Cross / styles / presets / UI / LibreCAD 検証）。
...
- Redline Stage 2: 横断テンプレート elevation・区間 UI・図面上下構成（[redline_ui_and_drawing_remediation_design.md](../../../road/output/redline_ui_and_drawing_remediation_design.md)）
- Step2 / Step3 の PR 境界
- Open Decision の集中管理
...
6. crossfall interval は station 依存の回転状態のみを担い、template `offsetLines[].elevation` が基準横断形状を担う（[redline_ui_and_drawing_remediation_design.md](../../../road/output/redline_ui_and_drawing_remediation_design.md) §4）。
...
- Step3 PR1: DXF core — **COMPLETE**
- Step3 PR2–PR6: Plan / Profile+Band / Cross / Styles+Presets / CAD compatibility + UI — **IN PROGRESS**（単一完遂ブランチ `feat/phase5-step3-complete-dxf`）
...
Stage 2 是正仕様は [redline_ui_and_drawing_remediation_design.md](../../../road/output/redline_ui_and_drawing_remediation_design.md) を正とする。
...
- [README.md](README.md)
- [phase5_liner_formal_drawing_design.md](../../../road/output/phase5_liner_formal_drawing_design.md)
- [drawing_model_design.md](../../../road/output/drawing_model_design.md)
- [crossfall_transition_design.md](../../../road/design/crossfall_transition_design.md)
- [implementation_plan.md](implementation_plan.md)
- [formal_drawing_ui_design.md](../../../road/output/formal_drawing_ui_design.md)
- [drawing_standard_preset_design.md](../../../road/output/drawing_standard_preset_design.md)
- [dxf_export_design.md](../../../road/output/dxf_export_design.md)
- [redline_ui_and_drawing_remediation_design.md](../../../road/output/redline_ui_and_drawing_remediation_design.md)
