...
- [intermediate_result_model.md](../../road/design/intermediate_result_model.md)
- [geometry_core.md](../../road/design/geometry_core.md)
- [frame_model_mapping.md](../../road/legacy-integration/frame_model_mapping.md)
- [integration_with_frame_model.md](../../road/legacy-integration/integration_with_frame_model.md)
- [calculation_pipeline.md](../../road/design/calculation_pipeline.md)
- [domain_model.md](../../road/design/domain_model.md)
- [coordinate_system_policy.md](../../road/design/coordinate_system_policy.md)
- [test_plan_geometry.md](../../road/verification/test_plan_geometry.md)
- [project_file_format.md](../../road/legacy-integration/project_file_format.md)
- [import_export_policy.md](../../road/legacy-integration/import_export_policy.md)
- [file_io_edge_cases.md](../../road/legacy-integration/file_io_edge_cases.md)
- [schema_migration_policy.md](../../road/legacy-integration/schema_migration_policy.md)
- [ui_window_spec.md](../../road/ui/ui_window_spec.md)
- [input_ui_behavior.md](../../road/ui/input_ui_behavior.md)
- [rendering_strategy.md](../../road/ui/rendering_strategy.md)
...
| --- | --- | --- | --- |
| `vertical` | [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §3; [geometry_core.md](../../road/design/geometry_core.md) §4 | Vertical helper functions exist but are not assembled into `LinerIntermediateResult`. | Add `VerticalGeometryResult`, connect profile input, emit profile samples and grade breaks. |
| `grid` | [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §6-§7; [geometry_core.md](../../road/design/geometry_core.md) §7 | Flat `gridPoints` exist, but no `GridResult` wrapper, grid lines, or cells. | Replace top-level `gridPoints` with `grid: { points, lines, cells }`; generate lines/cells deterministically. |
| `spans` | [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §8; [domain_model.md](../../road/design/domain_model.md) Core entities | Not implemented. | Add domain span inputs and intermediate span results, even if empty for simple fixtures. |
| `piers` | [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §8; [frame_model_mapping.md](../../road/legacy-integration/frame_model_mapping.md) §6 | Not implemented. | Add pier inputs/results and support-line point resolution. |
| `frameHints` | [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §9; [frame_model_mapping.md](../../road/legacy-integration/frame_model_mapping.md) §3, §5, §6 | Not implemented. | Add connectivity mode, member group rules, default group key, and support templates to intermediate result. |
| `dependencyGraph` | [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §13; [line_dependency_graph.md](../../road/design/line_dependency_graph.md) | Not implemented. | Add a minimal `DependencySnapshot` with node ids/kinds and invalidation metadata. |
| `diagnostics` | [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §11; [error_handling.md](../../road/design/error_handling.md) | Implemented as `issues`; catalog is partial. | Rename/bridge to `diagnostics`, add `messageKey?`, and expand diagnostic code union to the design catalog. |
...
| `frontend/src/liner/core/types.ts` | `CoordinateSystemMarker` | Minimal Phase 0 marker. | Keep as implementation support if it maps to `coordinatePolicyId`; consider documenting in [coordinate_system_policy.md](../../road/design/coordinate_system_policy.md) only if it becomes persisted or public. |
...
[test_plan_geometry.md](../../road/verification/test_plan_geometry.md) GC-02 currently states:
...
- [coordinate_system_policy.md](../../road/design/coordinate_system_policy.md) §2 defines azimuth from `+X` toward `+Y`, CCW positive.
- [coordinate_system_policy.md](../../road/design/coordinate_system_policy.md) §2 defines left turn as positive curvature.
- [geometry_core.md](../../road/design/geometry_core.md) §2 defines left arc curvature as `κ = +1/R`.
...
The GC-02 midpoint y value should be corrected from `13.397459` to `17.037087` in [test_plan_geometry.md](../../road/verification/test_plan_geometry.md). This is a design numeric fixture correction, not an implementation change.
...
1. **P1-1a Intermediate Result convergence:** make the runtime type match [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §1-§15.
...
1. `frontend/src/liner` exposes a canonical `LinerIntermediateResult` matching [intermediate_result_model.md](../../road/design/intermediate_result_model.md) §1-§15.
...
| --- | --- | --- |
| P1-D01 | Approve GC-02 midpoint y correction in [test_plan_geometry.md](../../road/verification/test_plan_geometry.md). | Geometry owner; this review recommends correction. |
...
| P1-D04 | Approve additive schema extension shape for `liner` and `linerTrace`. | Schema owner; see [schema_migration_policy.md](../../road/legacy-integration/schema_migration_policy.md). |
