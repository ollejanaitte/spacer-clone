...
This document defines the verification design for validating the future Linear Time History Analysis implementation described in `docs/frame/analysis/time-history-analysis.md`.
...
- `docs/frame/analysis/time-history-analysis.md` defines the Newmark-beta linear time integration, the Rayleigh damping model, the input data model, the result model, and the future nonlinear extension.
- The present document (`docs/frame/verification/time-history-sdof-verification.md`) defines how the linear portion of that design is verified before it is exposed to MDOF models.
...
### Case A Reference Analytical Solution
...
### Case B Reference Analytical Solution
...
### Case C Reference Analytical Solution
...
### Case D Reference Analytical Solution
...
### Time Step Sensitivity Verification Checks
