...
- [moving-load-design-review.md](../../history/frame/design/moving-load-design-review.md): design issues and stage separation
- [result-schema.md](../contracts/result-schema.md): the overall result schema
- [result-visualization.md](../viewer/result-visualization.md): conversion from results to the display model
