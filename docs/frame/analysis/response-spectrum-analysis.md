...
The authoritative source for the response spectrum result is [result-schema.md](../contracts/result-schema.md) and `responseSpectrumResult` in `schemas/result.schema.json`.
