...
Eigenvalue analysis and response spectrum analysis are added later as the Phase E extension. See [eigen-analysis.md](eigen-analysis.md) and [response-spectrum-analysis.md](response-spectrum-analysis.md). Section 4 of this document covers the linear static MVP.
...
- The required verification cases in `docs/frame/verification/11_test_spec.md` pass.
- The numerical tolerances in `docs/development/quality-gates.md` are satisfied.
- The engine can run analyses standalone, without the API or UI.
- The results can be converted into the format described in `docs/frame/contracts/06_result_schema.md`.
...
- Reference: [eigen-analysis.md](eigen-analysis.md)
...
- Reference: [response-spectrum-analysis.md](response-spectrum-analysis.md)
