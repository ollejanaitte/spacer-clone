...
[time-history-api-contract.md](../contracts/time-history-api-contract.md); the
persisted result block lives in [result-schema.md](../contracts/result-schema.md).
...
- The chart uses the existing project's chart infrastructure.
  **DEFERRED:** The choice between Recharts, d3, or a thin custom SVG renderer belongs to the Frame
  UI owner. **Gate:** resolve it in the implementation PR design review.
...
- [time-history-api-contract.md](../contracts/time-history-api-contract.md)
- [time-history-schema.md](../contracts/time-history-schema.md)
- [time-history-analysis.md](../analysis/time-history-analysis.md)
- [time-history-implementation-plan.md](../../history/frame/design/time-history-implementation-plan.md)
