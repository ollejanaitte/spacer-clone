...
All rows below remain **OPEN**. Owner is the Road drawing UI owner; decision gate is Stage 8 `O8`
evidence and Stage 10 `G6` / Phase P6 before release. Recommended initial values are not accepted
Stage 6-10 decisions.
