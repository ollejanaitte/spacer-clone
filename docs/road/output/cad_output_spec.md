...
- 3D solid export (see [rendering_strategy.md](../ui/rendering_strategy.md) for 3D preview scope).
...
- Higher density requires pipeline re-run with updated sample spacing ([calculation_pipeline.md](../design/calculation_pipeline.md)).
...
- [unit_and_precision_policy.md](../design/unit_and_precision_policy.md)
