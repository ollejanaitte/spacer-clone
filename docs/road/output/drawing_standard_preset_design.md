...
> Related docs: [README.md](../../history/road/phase5/README.md), [formal_drawing_ui_design.md](formal_drawing_ui_design.md), [dxf_export_design.md](dxf_export_design.md), [phase5_liner_formal_drawing_design.md](phase5_liner_formal_drawing_design.md)
...
詳細は [step3_complete_dxf_implementation.md](../../history/road/phase5/step3_complete_dxf_implementation.md)。
...
All rows below remain **OPEN**. Owner is the Road drawing/output owner with drawing/report QA;
decision gate is Stage 8 `O8` evidence and Stage 10 `G6` / Phase P6 before release. Phase 5 defaults
remain proposals and are not promoted to Stage 6-10 decisions.
