...
> Related docs: [README.md](../../history/road/phase5/README.md), [drawing_model_design.md](drawing_model_design.md), [crossfall_transition_design.md](../design/crossfall_transition_design.md), [implementation_plan.md](../../history/road/phase5/implementation_plan.md), [formal_drawing_ui_design.md](formal_drawing_ui_design.md), [drawing_standard_preset_design.md](drawing_standard_preset_design.md), [dxf_export_design.md](dxf_export_design.md), [redline_ui_and_drawing_remediation_design.md](redline_ui_and_drawing_remediation_design.md), [../cad_output_spec.md](cad_output_spec.md)
