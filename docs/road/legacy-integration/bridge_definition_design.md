...
> The body-level source-of-truth and phased-unification statements are limited to the retained Phase 4.5 legacy design. `BridgeDefinition` is not a target system of record, `RoadToFrameTransferPackage`, or direct apply authority. Use the [transfer crosswalk](../../transfer/contract-index.md) and [formal contract](../../planning/stage6-10/road_to_frame_contract.md) for target ownership and integration.
<!-- DOC-AUTHORITY:END -->
...
> Repo: spacer-clone
> 作成日: 2026年7月8日
> 関連: [integration_with_frame_model.md](integration_with_frame_model.md), [phase35_bridge_adapter_spec.md](../../history/road/phase3.6/phase35_bridge_adapter_spec.md), [bridge-domain-model.md](../../frame/modeler/bridge-domain-model.md), [bridge-fem-generator.md](../../frame/modeler/bridge-fem-generator.md)
...
| O8 | 座標系・軸方向・符号 | [coordinate_system_policy.md](../design/coordinate_system_policy.md) との統一。Wizard y 对称 vs LINER measured grid | Step 5 前 |
...
| [phase35_bridge_adapter_spec.md](../../history/road/phase3.6/phase35_bridge_adapter_spec.md) | Importer → Phase 3.5 adapter |
| [frame_model_mapping.md](frame_model_mapping.md) | 現行 mapper 規則 |
| [bridge-domain-model.md](../../frame/modeler/bridge-domain-model.md) | BridgeProject 現行定義 |
| [bridge-fem-generator.md](../../frame/modeler/bridge-fem-generator.md) | Wizard FEM 生成仕様 |
| [coordinate_system_policy.md](../design/coordinate_system_policy.md) | 座標系 |
| [normalization_context_design.md](../../history/road/phase3.7/normalization_context_design.md) | Importer 正規化 |
