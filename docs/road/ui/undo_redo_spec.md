...
- Undo restores domain state; pipeline re-runs automatically after undo ([recalculation_policy.md](../design/recalculation_policy.md)).
...
See [recalculation_policy.md](../design/recalculation_policy.md) §5 for full table. Summary:
