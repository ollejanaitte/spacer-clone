...
- **DEFERRED:** Snap to grid points, segment endpoints, and station increments. Owner is the Road UI
  owner; gate is the snap implementation PR and its acceptance definition.

### Validation and compute gating

Per [validation_rules.md](../design/validation_rules.md) and [error_handling.md](../design/error_handling.md):
