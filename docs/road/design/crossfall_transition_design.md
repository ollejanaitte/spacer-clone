...
> Date: 2026-07-13
> Redline: [redline_ui_and_drawing_remediation_design.md](../output/redline_ui_and_drawing_remediation_design.md)
> Phase: Phase 5 / 第1編補遺
...
OD-13 remains **OPEN**. Owner is the Road geometry owner; gate is the measured-grid precedence
decision before crossfall implementation acceptance and Road-to-Frame geometry verification.
...
詳細・日本語 diagnostic 文言は [redline_ui_and_drawing_remediation_design.md](../output/redline_ui_and_drawing_remediation_design.md) §4 を正とする。
...
- pivot 境界ちょうど
- measured grid 優先
- **DEFERRED:** width unresolved case. Owner is the Road geometry owner; gate is width-resolution
  behavior and acceptance before crossfall implementation release. Do not infer a fallback here.
- vertical 無し
- sourceRevision 固定
- 0 offset
- negative offset
