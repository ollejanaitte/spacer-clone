...
- Benchmarks reference [test_plan_geometry.md](../verification/test_plan_geometry.md) smoke tests.
...
| --- | --- | --- |
| 1000 grid points pipeline | < 500 ms | [test_plan_geometry.md](../verification/test_plan_geometry.md) §7 |
| 5000 nodes mapper | < 200 ms | [test_plan_geometry.md](../verification/test_plan_geometry.md) §7 |
