...
- **File format (OPEN):** The target persisted envelope and extension remain owned by the target
  data/persistence owner and must be resolved before the target writer/schema release. Do not infer
  the answer from the legacy [project file format](../legacy-integration/project_file_format.md); use
  [Stage 7 contracts](../../planning/stage6-10/stage7_shared_platform_and_contracts.md) and the
  [Stage 10 sequence](../../planning/stage6-10/stage10_gap_migration_sequence.md) as the decision gate.
...
- [ ] No copied file extensions or proprietary binary/text formats ([import_export_policy.md](../legacy-integration/import_export_policy.md))
- [ ] Original report layout and table order ([report_output_spec.md](../output/report_output_spec.md))
- [ ] Original drawing layers and title block ([cad_output_spec.md](../output/cad_output_spec.md))
- [ ] Golden fixtures and tests do not embed third-party strings ([test_plan_cad_report.md](../verification/test_plan_cad_report.md))
...
- [ui_window_spec.md](../ui/ui_window_spec.md)
