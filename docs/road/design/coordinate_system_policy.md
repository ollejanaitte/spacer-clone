...
- Right-handed coordinate system: +X, +Y, +Z per structural convention in [docs/frame/contracts/04_input_schema.md](../../frame/contracts/04_input_schema.md).
...
Per [frame_model_mapping.md](../legacy-integration/frame_model_mapping.md) and `project.schema.json`:
...
- No additional silent transform at frame merge ([integration_with_frame_model.md](../legacy-integration/integration_with_frame_model.md)).

### 7. Verification

- GC-07 confirms left-normal offset sign at 45° azimuth ([test_plan_geometry.md](../verification/test_plan_geometry.md)).
...
- [ ] coordinatePolicy schema field defined in [project_file_format.md](../legacy-integration/project_file_format.md).
