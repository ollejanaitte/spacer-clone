...
Golden cases GC-08 through GC-10 in [test_plan_geometry.md](test_plan_geometry.md).
...
Golden files: input domain JSON → expected intermediate result JSON ([test_plan_geometry.md](test_plan_geometry.md)).
