...
### 18. Pre-Decision #Q: Undo / Redo ??

Phase 3.6 ?????? Undo / Redo ???????? 50 ???????????????? Undo ????????????????????????????????????? Undo ???????????

?????????????`********` ?????????Point??????????????????????????????? I/O???????????????????????? Ctrl+Z ? Undo?Ctrl+Y ??? Ctrl+Shift+Z ? Redo ????

### 19. Pre-Decision #R: PDF ???????

Phase 3.6 ??? PDF ???????????????Pre-Decision #K?????????????? PDF ????????????

??????????????SHA-256 ???????????????????????????????????? M2 ? `JipLinerImporterProject.sourcePdfRefs[]` ??????`sourceRef.pdfPage` ????????????
