...
> **Related docs:**
> - [bridge_definition_architecture_freeze.md](./bridge_definition_architecture_freeze.md) — Architecture Freeze（§9 一致基準の再定義）
> - [bridge_definition_design.md](./bridge_definition_design.md) — Phase 4.5 全体設計
