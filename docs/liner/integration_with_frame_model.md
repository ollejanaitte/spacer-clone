...
- **MVP execution boundary:** TypeScript-only pure core and mapper in frontend; backend validates merged project schema only — no geometry recompute on server ([calculation_pipeline.md](calculation_pipeline.md)).
