...
| Export grid table | CSV | From [report_output_spec.md](report_output_spec.md) |
...
Functional equivalence is achieved through original JSON schemas and pipelines ([legal_originality_policy.md](legal_originality_policy.md)).
