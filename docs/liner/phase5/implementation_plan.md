...
> Phase: Phase 5 / Plan
> Related docs: [README.md](README.md), [formal_drawing_ui_design.md](formal_drawing_ui_design.md), [dxf_export_design.md](dxf_export_design.md), [drawing_standard_preset_design.md](drawing_standard_preset_design.md), [phase5_liner_formal_drawing_design.md](phase5_liner_formal_drawing_design.md), [drawing_model_design.md](drawing_model_design.md), [crossfall_transition_design.md](crossfall_transition_design.md), [redline_ui_and_drawing_remediation_design.md](redline_ui_and_drawing_remediation_design.md)
...
- Redline RL-01〜11 は [redline_ui_and_drawing_remediation_design.md](redline_ui_and_drawing_remediation_design.md) の AC-RD-01〜20 に対応（Stage 2）。
- **DXF scope 不変。Step 3 PR2（Plan export）は未着手。**
...
flowchart TB
  ...
  S2 --> P1 --> P2 --> P2R["PR2-RL Crossfall / Z remediation"] --> P3 --> P4 --> P4R["PR4-RL Plan composition"] --> P5 --> P5R["PR5-RL Profile/band composition"] --> P6 --> P7 --> S3 --> D1 --> D2["Step3 PR2 Plan export (NOT STARTED)"] --> D3 --> D4 --> D5 --> D6
```
...
- Status: **NOT STARTED** — DXF scope 変更なし
- Dependencies: PR1
- Target files: plan export
- New files: plan dxf mapping
- Tests: line / text entity tests
- Manual verification: plan 目視
...
- Risk: lineweight
- Complexity: M
- Exit gate: plan の screen parity が取れる
...
- Redline RL-A〜H が PR にマップされている（[redline_ui_and_drawing_remediation_design.md](redline_ui_and_drawing_remediation_design.md) §16）
...
- Step 3 PR2 は **NOT STARTED** と明記される
