...
- Layer ids follow [cad_output_spec.md](cad_output_spec.md) naming (`LINER_PLAN_*`).
...
- HTML contains sections per [report_output_spec.md](report_output_spec.md) keys.
...
Per [legal_originality_policy.md](legal_originality_policy.md) review gates.
