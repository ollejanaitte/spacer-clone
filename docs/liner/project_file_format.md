...
- Serialization of domain entities defined in [domain_model.md](domain_model.md).
- `linerTrace` reference policy when embedded in app project.
- Metadata: created/updated timestamps, author, description.

## Out of Scope

- Frame analysis `project.json` schema (see [docs/04_input_schema.md](../04_input_schema.md)).
