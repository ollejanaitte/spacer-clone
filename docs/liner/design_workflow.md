...
2. Confirm relationship to the existing frame analysis MVP ([docs/02_mvp_scope.md](../02_mvp_scope.md)).
...
**Goal:** Define layer boundaries consistent with [docs/03_architecture.md](../03_architecture.md).
...
4. Draft [calculation_pipeline.md](calculation_pipeline.md) and [state_management.md](state_management.md).
...
**Exit criteria:** Algorithm inventory complete; unit tests identified in [test_plan_geometry.md](test_plan_geometry.md).
...
3. Connect to [frame_model_mapping.md](frame_model_mapping.md) node generation.
...
1. Complete [integration_with_frame_model.md](integration_with_frame_model.md) — **critical path**.
2. Complete [frame_model_mapping.md](frame_model_mapping.md) with node/member/support generation rules.
3. Cross-check against [docs/04_input_schema.md](../04_input_schema.md) and existing bridge FEM generator patterns.
...
3. Align with [state_management.md](state_management.md).
...
1. Draft [state_management.md](state_management.md) and [undo_redo_spec.md](undo_redo_spec.md).
...
1. Draft [ui_window_spec.md](ui_window_spec.md) and [input_ui_behavior.md](input_ui_behavior.md).
...
1. Draft [rendering_strategy.md](rendering_strategy.md).
...
1. Draft [cad_output_spec.md](cad_output_spec.md) and [report_output_spec.md](report_output_spec.md).
2. Draft [import_export_policy.md](import_export_policy.md).
3. Plan tests in [test_plan_cad_report.md](test_plan_cad_report.md).
...
2. Reconcile with frame model axes in [docs/04_input_schema.md](../04_input_schema.md).
...
1. Draft [project_file_format.md](project_file_format.md) and [schema_migration_policy.md](schema_migration_policy.md).
2. Draft [file_io_edge_cases.md](file_io_edge_cases.md).
...
1. Complete [test_plan_geometry.md](test_plan_geometry.md) — **critical**.
2. Draft [test_plan_cad_report.md](test_plan_cad_report.md).
3. Cross-check [docs/12_quality_gate.md](../12_quality_gate.md).
...
| D-LINER-002 | Frame entity traceability | **Resolved** | ID prefix + `linerTrace` table until `meta` extension — [integration_with_frame_model.md](integration_with_frame_model.md) |
| D-LINER-003 | MVP compute boundary | **Resolved** | TypeScript-only frontend — [calculation_pipeline.md](calculation_pipeline.md) |
| D-LINER-004 | Bridge wizard reuse | **Resolved** | Separate mapper; shared helpers only — [integration_with_frame_model.md](integration_with_frame_model.md) §10 |
| D-LINER-005 | CAD MVP format | **Resolved** | SVG with defined layers — [cad_output_spec.md](cad_output_spec.md) |
| D-LINER-006 | Optional `meta` on nodes/members | Open | Schema owner; see [schema_migration_policy.md](schema_migration_policy.md) |
| D-LINER-007 | 3D glTF export scope | Open | Post-MVP unless added to [rendering_strategy.md](rendering_strategy.md) |
| D-LINER-008 | Liner file extension | Open | [project_file_format.md](project_file_format.md) |
