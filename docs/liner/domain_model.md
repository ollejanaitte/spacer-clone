...
- FEM nodes, members, supports (see [frame_model_mapping.md](frame_model_mapping.md)).
- UI form field binding (see [input_ui_behavior.md](input_ui_behavior.md)).
...
- [docs/design/bridge-domain-model.md](../design/bridge-domain-model.md)
